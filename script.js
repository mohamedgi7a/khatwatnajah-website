...
const translations = {
  ar: {
    ...
    "services.pestAlt": "خدمة مكافحة الحشرات من خطوة نجاح",
    "services.pestTitle": "مكافحة الحشرات",
    "services.pestCopy": "برامج مكافحة آمنة ومنظمة للمنشآت مع متابعة دورية حسب الحاجة.",
    ...
    "services.paintingAlt": "خدمات الدهانات والترميم من خطوة نجاح",
    "services.paintingTitle": "الدهانات والترميم",
    "services.paintingCopy": "أعمال دهان وترميم داخلية وخارجية لمعالجة التشققات وتحسين جاهزية المنشأة.",
    "services.landscapingAlt": "فريق زراعة وتشجير من خطوة نجاح",
    "services.landscapingTitle": "الزراعة والتشجير",
    "services.landscapingCopy": "تنسيق المساحات الخارجية، التشجير، والعناية الدورية بالمزروعات.",
    "services.facadeAlt": "خدمة نظافة الواجهات",
    "services.facadeTitle": "نظافة الواجهات",
    "services.facadeCopy": "تنظيف واجهات زجاجية وخارجية بفرق مجهزة وإجراءات سلامة واضحة.",
    ...
    "sectors.quote": "في خطوة نجاح، لا نوفر العمالة فقط؛ بل نقدم إشرافاً ومتابعة وتشغيلاً منظماً يجعل إدارة المنشأة أسهل وأكثر استقراراً.",
    "sectors.quoteBy": "قيمة نؤمن بها في كل موقع نخدمه",
  ...
  en: {
    ...
    "services.pestAlt": "Khatwat Najah pest control service",
    "services.pestTitle": "Pest Control",
    "services.pestCopy": "Safe and organized pest control programs for facilities with scheduled follow-up.",
    ...
    "services.paintingAlt": "Khatwat Najah painting and restoration service",
    "services.paintingTitle": "Painting and Restoration",
    "services.paintingCopy": "Interior and exterior painting and restoration works to repair cracks and improve facility readiness.",
    "services.landscapingAlt": "Khatwat Najah landscaping team",
    "services.landscapingTitle": "Landscaping and Planting",
    "services.landscapingCopy": "Outdoor area coordination, planting, and routine plant care.",
    "services.facadeAlt": "Facade cleaning service",
    "services.facadeTitle": "Facade Cleaning",
    "services.facadeCopy": "Glass and exterior facade cleaning with equipped teams and clear safety procedures.",
    ...
    "sectors.quote": "At Khatwat Najah, we do more than provide manpower; we deliver supervision, follow-up, and organized operations that make facility management easier and more stable.",
    "sectors.quoteBy": "A value we apply in every site we serve.",
    ...
    "form.servicePainting": "Painting and Restoration",
    "form.serviceHospitality": "Hospitality Services",
    "form.servicePest": "Pest Control",
    "form.serviceLandscaping": "Landscaping and Planting",
    "form.serviceFacade": "Facade Cleaning",
    ...
    "form.note": "After submitting your request, the Khatwat Najah team will contact you as soon as possible.",
